...
import { AiOutlineClose, AiOutlineShoppingCart, AiOutlineUser, AiOutlineSearch } from "react-icons/ai";
    ...
    <div className="relative font-satoshi">
      <div className="bg-black p-3 flex justify-center items-center">
        <p className="text-white text-sm font-medium">
          Sign up and get 20% off your first order. <span className="underline cursor-pointer hover:text-white transition duration-300">Sign Up Now</span>
        </p>
      ...
      <nav className="bg-white shadow-md flex items-center justify-between px-8 py-4">
        <h1 className="font-extrabold text-4xl ml-8 text-black tracking-wide">SHOP.CO</h1>
        <ul className="flex space-x-8">
          <li className="cursor-pointer hover:text-black transition duration-300">
            <select className="border border-transparent bg-transparent cursor-pointer focus:outline-none font-medium">
              <option>Shop</option>
          ...
          <li className="cursor-pointer hover:text-indigo-600 transition duration-300">On Sale</li>
          <li className="cursor-pointer hover:text-indigo-600 transition duration-300">New Arrivals</li>
          <li className="cursor-pointer hover:text-indigo-600 transition duration-300">Brands</li>
        </ul>
